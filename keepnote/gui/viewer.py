...
gobject.signal_new("error", Viewer, gobject.SIGNAL_RUN_LAST, gobject.TYPE_NONE, (str, object))
gobject.signal_new("status", Viewer, gobject.SIGNAL_RUN_LAST, gobject.TYPE_NONE, (str, str))
gobject.signal_new("history-changed", Viewer, gobject.SIGNAL_RUN_LAST, gobject.TYPE_NONE, (object,))
gobject.signal_new("window-request", Viewer, gobject.SIGNAL_RUN_LAST, gobject.TYPE_NONE, (str,))
gobject.signal_new("modified", Viewer, gobject.SIGNAL_RUN_LAST, gobject.TYPE_NONE, (bool,))
gobject.signal_new("current-node", Viewer, gobject.SIGNAL_RUN_LAST, gobject.TYPE_NONE, (object,))
